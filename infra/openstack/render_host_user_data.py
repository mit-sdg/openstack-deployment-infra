...
from platform_cli.config import load_platform  # noqa: E402
from platform_cli.host_user_data import (  # noqa: E402
    PERSISTENT_ROLES,
    HostUserDataInputs,
    render_host_user_data_file,
)
from platform_cli.validation import ValidationError, uuid  # noqa: E402
...
def main() -> int:
    ...
    parser.add_argument("--agentops-public-key", type=Path, required=True)
    ...
    try:
        render_host_user_data_file(
            ...
            HostUserDataInputs(
                ...
                agentops_public_key=args.agentops_public_key,
