...
class ApplicationActionTests(unittest.TestCase):
    ...
    def test_promotion_requires_exact_healthy_candidate_before_stable_submit(self) -> None:
        ...
        inspections = {
            "demo-app": {
                ...
                "Version": 3,
                "Meta": {
                    "platform_candidate_job_sha256": "0" * 64,
                    "platform_candidate_image": CANDIDATE_IMAGE,
                },
                "TaskGroups": [
                    {
            ...
            "demo-app-candidate": {
                ...
                "Version": 8,
                "Meta": {
                    "platform_candidate_job_sha256": candidate_identity[0],
                    "platform_candidate_image": candidate_identity[1],
                    "platform_route_marker": "00000000-0000-4000-8000-000000000099",
                },
                "TaskGroups": [
                    {
                        "Name": "app",
        ...
        def runner(argv: tuple[str, ...], **kwargs: object) -> SimpleNamespace:
            ...
            if "inspect" in argv:
                ...
                inspections["demo-app-candidate"] = {
                    ...
                    "Version": 9,
                    "Meta": {
                        "platform_candidate_job_sha256": promoted_identity[0],
                        "platform_candidate_image": promoted_identity[1],
                    },
                    "TaskGroups": [
                        {
                            "Name": "app",
    ...
    def test_deploy_rejects_unmarked_unmanaged_job_before_provider_calls(self) -> None:
        ...
        def runner(argv: tuple[str, ...], **kwargs: object) -> SimpleNamespace:
            ...
            if "inspect" in argv:
                ...
                current = {
                    ...
                    "Version": 8,
                    "Meta": {
                        "platform_candidate_job_sha256": candidate[0],
                        "platform_candidate_image": candidate[1],
                    },
                    "TaskGroups": [
                        {
                            "Name": "app",
    ...
    def test_health_rejects_stale_version_duplicate_allocations_and_candidate_metadata_drift(
        ...
        self.nomad.inspection["Meta"]["platform_candidate_job_sha256"] = "c" * 64
