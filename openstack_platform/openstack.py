...
# Image publication, selection, and retention
...
def check_role_health(
    ...
    *,
    ...
    if command:
        ...
        # be interpreted as an executable path on the external operator host.
...
# Metadata projection entry point used by the image publisher
