...
from ..contracts import (
    MONGO_GENERATION_FIELD,
    MONGO_OPERATION_FIELD,
    MONGO_OWNER_FIELD,
    MONGODB_PORT,
    POSTGRES_OWNERSHIP_MARKER_PREFIX,
    POSTGRES_PORT,
)
...
# PostgreSQL provider primitives
...
_POSTGRES_MARKER_PREFIX = POSTGRES_OWNERSHIP_MARKER_PREFIX
...
_MONGO_OWNER_FIELD = MONGO_OWNER_FIELD
_MONGO_OPERATION_FIELD = MONGO_OPERATION_FIELD
_MONGO_GENERATION_FIELD = MONGO_GENERATION_FIELD
...
def mongo_create(
    ...
    *,
    ...
    # operation. In particular, never adopt an existing database as a managed
...
# Shared credential publication and recovery helpers
...
# Bounded helper action handlers
