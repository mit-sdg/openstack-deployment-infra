...
from .controller_http import ControllerServer

_DEFAULT_PLATFORM = Path(os.environ.get("PLATFORM_CONFIG", "/etc/openstack-platform/platform.json"))
_DEFAULT_STATE = Path("/srv/openstack-platform/state/controller")
_DEFAULT_SOCKET = Path("/run/openstack-platform/controller.sock")
